 ...
 * @author Grigor Iliev
 */
public class AddInstrumentDlg extends OkCancelDialog {
	private final JLabel lName = new JLabel(i18n.getLabel("AddInstrumentDlg.lName"));
	private final JLabel lDesc = new JLabel(i18n.getLabel("AddInstrumentDlg.lDesc"));
	private final JLabel lPath = new JLabel(i18n.getLabel("AddInstrumentDlg.lPath"));
	private final JLabel lIndex = new JLabel(i18n.getLabel("AddInstrumentDlg.lIndex"));
	
	private final JButton btnBrowse =
		new JButton(i18n.getButtonLabel("AddInstrumentDlg.btnBrowse"));
	...
	/** Creates a new instance of <code>AddInstrumentDlg</code>. */
	public AddInstrumentDlg() { this(new Instrument()); }
	
	/**
	 * Creates a new instance of <code>AddInstrumentDlg</code>.
	 * @param instr The instrument to modify.
	 */
	public AddInstrumentDlg(Instrument instr) {
		super(CC.getMainFrame(), i18n.getLabel("AddInstrumentDlg.title"));
	...
	private class Handler implements DocumentListener, ActionListener {
		...
		actionPerformed(ActionEvent e) {
			...
			int result = fc.showOpenDialog(AddInstrumentDlg.this);
