...
import com.grigoriliev.jsampler.fantasia.view.basic.FantasiaComboBox;
...
public class NormalChannelOptionsView extends JPanel implements ChannelOptionsView {
	...
	NormalChannelOptionsView(final Channel channel) {
		...
		btnChannelRouting.setToolTipText(FantasiaI18n.i18n.getLabel("ChannelOptions.routing"));
	...
	updateCbInstrumentMapToolTipText() {
		...
		if(m != null) {
			String s = FantasiaI18n.i18n.getLabel("Channel.ttDefault", m.getName());
