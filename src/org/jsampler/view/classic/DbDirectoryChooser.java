 ...
 * @author Grigor Iliev
 */
public class DbDirectoryChooser extends OkCancelDialog implements TreeSelectionListener {
	private InstrumentsDbTree instrumentsDbTree;
	
	/** Creates a new instance of <code>DbDirectoryChooser</code>. */
	public
	DbDirectoryChooser(Frame owner) {
		super(owner, i18n.getLabel("DbDirectoryChooser.title"));
		initDbDirectoryChooser();
	}
	
	/** Creates a new instance of <code>DbDirectoryChooser</code>. */
	public
	DbDirectoryChooser(Dialog owner) {
		super(owner, i18n.getLabel("DbDirectoryChooser.title"));
		initDbDirectoryChooser();
	}
