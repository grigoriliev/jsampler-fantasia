...
public class MidiDevicesPane extends JPanel {
	...
	class NewDevicePane extends FantasiaPanel {
		...
		NewDevicePane() {
			...
			String s = FantasiaI18n.i18n.getLabel("MidiDevicesPane.newDevice");
		...
		getCreateDevicePane() {
			...
			createDevicePane.setAnimated(FantasiaPrefs.preferences().getBoolProperty(FantasiaPrefs.ANIMATED));
