...
public class InstrumentsDbFrame extends JFrame {
	...
	addMenu() {
		...
		// Actions
		m = new JMenu(FantasiaI18n.i18n.getMenuLabel("instrumentsdb.actions"));
		menuBar.add(m);
		...
		JMenu addInstrumentsMenu =
			new JMenu(FantasiaI18n.i18n.getMenuLabel("instrumentsdb.actions.addInstruments"));
		...
		mi = new JMenuItem(FantasiaI18n.i18n.getMenuLabel("instrumentsdb.actions.format"));
		m.add(mi);
		mi.addActionListener(new ActionListener() {
			public void
			actionPerformed(ActionEvent e) {
				String s = FantasiaI18n.i18n.getMessage("InstrumentsDbFrame.formatDatabase?");
				if(!SHF.showYesNoDialog(InstrumentsDbFrame.this, s)) return;
				CC.getTaskQueue().add(new InstrumentsDb.Format());
			}
		});
		
		mi = new JMenuItem(FantasiaI18n.i18n.getMenuLabel("instrumentsdb.actions.checkForLostFiles"));
		m.add(mi);
		mi.addActionListener(new ActionListener() {
			public void
			actionPerformed(ActionEvent e) {
		...
		loadInstrumentMenu =
			new JMenu(FantasiaI18n.i18n.getMenuLabel("instrumentsdb.actions.loadInstrument"));
		m.add(loadInstrumentMenu);
		mainPane.getInstrumentsTable().registerLoadInstrumentMenus(loadInstrumentMenu);
		
		addToMidiMapMenu =
			new JMenu(FantasiaI18n.i18n.getMenuLabel("instrumentsdb.actions.addToMidiMap"));
		m.add(addToMidiMapMenu);
		mainPane.getInstrumentsTable().registerAddToMidiMapMenu(addToMidiMapMenu);
		
		addToOrchestraMenu =
			new JMenu(FantasiaI18n.i18n.getMenuLabel("instrumentsdb.actions.addToOrchestra"));
		...
		m = new JMenu(FantasiaI18n.i18n.getMenuLabel("instrumentsdb.edit"));
		menuBar.add(m);
		...
		mi = new JMenuItem(FantasiaI18n.i18n.getMenuLabel("instrumentsdb.edit.find"));
		...
		m = new JMenu(FantasiaI18n.i18n.getMenuLabel("instrumentsdb.go"));
		menuBar.add(m);
	...
	class MainPane extends JPanel {
		...
		MainPane() {
			...
			instrumentsTable.getModel().setShowDummyColumn(false);
	...
	class SidePane extends NavigationPane {
		...
		SidePane() {
			...
			foldersPage.setTitle(FantasiaI18n.i18n.getLabel("InstrumentsDbFrame.folders"));
