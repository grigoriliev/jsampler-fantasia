...
import com.grigoriliev.jsampler.swing.view.std.JSPianoRoll;
...
import static com.grigoriliev.jsampler.task.Global.GetFileInstrument;
...
public class PianoKeyboardPane extends FantasiaPanel
			       implements com.grigoriliev.jsampler.event.ListSelectionListener, SamplerChannelListListener {
	...
	updateDisplay() {
		...
		if(channel == null) {
			lDisplay.setText(FantasiaI18n.i18n.getLabel("PianoKeyboardPane.noChannel"));
			return;
		}
		...
		sb.append(FantasiaI18n.i18n.getLabel("PianoKeyboardPane.channel", s)).append(" - ");
		
		int status = sc.getInstrumentStatus();
		if(status >= 0 && status < 100) {
			sb.append(FantasiaI18n.i18n.getLabel("ChannelScreen.loadingInstrument", status));
		} else if(status == -1) {
			sb.append(FantasiaI18n.i18n.getLabel("PianoKeyboardPane.noInstrument"));
		} else if(status < -1) {
			 sb.append(FantasiaI18n.i18n.getLabel("ChannelScreen.errorLoadingInstrument"));
		} else {
