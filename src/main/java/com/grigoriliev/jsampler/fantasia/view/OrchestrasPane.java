...
public class OrchestrasPane extends JPanel {
	...
	OrchestrasPane() {
		...
		orchestrasTaskPane.setTitle(FantasiaI18n.i18n.getLabel("OrchestrasPane.orchestrasTaskPane"));
		
		FantasiaSubPanel fsp = new FantasiaSubPanel(false, true, false);
		fsp.add(manageOrchestrasPane);
		orchestrasTaskPane.add(fsp);
		boolean b;
		orchestrasTaskPane.setAnimated(FantasiaPrefs.preferences().getBoolProperty(FantasiaPrefs.ANIMATED));
		b = FantasiaPrefs.preferences().getBoolProperty("OrchestrasPane.orchestrasTaskPane.expanded");
		...
		orchIdx = FantasiaPrefs.preferences().getIntProperty("OrchestrasPane.OrchestraIndex", 0);
	...
	savePreferences() {
		...
		FantasiaPrefs.preferences().setBoolProperty("OrchestrasPane.orchestrasTaskPane.expanded", b);
	}
	...
	orchestraChanged() {
		...
		if(i >= 0) FantasiaPrefs.preferences().setIntProperty("OrchestrasPane.OrchestraIndex", i);
	}
