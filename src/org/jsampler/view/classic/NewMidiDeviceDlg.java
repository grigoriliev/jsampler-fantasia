 ...
 * @author Grigor Iliev
 */
public class NewMidiDeviceDlg extends EnhancedDialog {
	private final JLabel lDriver = new JLabel(i18n.getLabel("NewMidiDeviceDlg.lDriver"));
	private final JComboBox cbDrivers = new JComboBox();
	private final ParameterTable parameterTable = new ParameterTable();
	
	private final JButton btnCreate =
		new JButton(i18n.getButtonLabel("NewMidiDeviceDlg.btnCreate"));
	...
	onOk() {
		...
		if(obj == null) {
			JOptionPane.showMessageDialog (
				this, i18n.getMessage("NewMidiDeviceDlg.selectDriver!"),
				"",
