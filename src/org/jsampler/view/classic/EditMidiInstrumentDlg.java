 ...
 * @author Grigor Iliev
 */
public class EditMidiInstrumentDlg extends OkCancelDialog {
	private final JLabel lName = new JLabel(i18n.getLabel("EditMidiInstrumentDlg.lName"));
	
	private final JLabel lFilename =
		new JLabel(i18n.getLabel("EditMidiInstrumentDlg.lFilename"));
	
	private final JLabel lIndex = new JLabel(i18n.getLabel("EditMidiInstrumentDlg.lIndex"));
	
	private final JLabel lEngine = new JLabel(i18n.getLabel("EditMidiInstrumentDlg.lEngine"));
	
	private final JLabel lLoadMode =
		new JLabel(i18n.getLabel("EditMidiInstrumentDlg.lLoadMode"));
	
	private final JLabel lVolume =
		new JLabel(i18n.getLabel("EditMidiInstrumentDlg.lVolume"));
	...
	/**
	 * Creates a new instance of <code>EditMidiInstrumentDlg</code>.
	 * @param instr The instrument whose settings should be edited.
	 */
	public EditMidiInstrumentDlg(MidiInstrumentInfo instr) {
		super(CC.getMainFrame(), i18n.getLabel("EditMidiInstrumentDlg.title"));
