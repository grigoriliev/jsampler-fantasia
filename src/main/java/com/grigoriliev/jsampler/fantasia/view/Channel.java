...
import com.grigoriliev.jsampler.fantasia.view.basic.PixmapToggleButton;
...
import com.grigoriliev.jsampler.swing.view.std.JSFxSendsDlg;
...
import static com.grigoriliev.jsampler.fantasia.view.A4n.a4n;
...
public class Channel extends SwingChannel {
	...
	public static class StreamVoiceCountPane extends JPanel {
		...
		StreamVoiceCountPane(Channel channel) {
			...
			lStreams.setToolTipText(FantasiaI18n.i18n.getLabel("Channel.streamVoiceCount"));
			...
			lSlash.setToolTipText(FantasiaI18n.i18n.getLabel("Channel.streamVoiceCount"));
			add(lSlash);
			
			lVoices.setFont(Res.fontScreenMono);
			lVoices.setToolTipText(FantasiaI18n.i18n.getLabel("Channel.streamVoiceCount"));
	...
	public static class PowerButton extends PixmapToggleButton implements ActionListener {
		...
		actionPerformed(ActionEvent e) {
			...
			if(b) {
				String s = FantasiaI18n.i18n.getMessage("Channel.remove?", channel.getChannelId());
	...
	public static class OptionsButton extends PixmapToggleButton
		...
		actionPerformed(ActionEvent e) {
			...
			String s;
			if(isSelected()) s = FantasiaI18n.i18n.getButtonLabel("Channel.ttHideOptions");
			else s = FantasiaI18n.i18n.getButtonLabel("Channel.ttShowOptions");
