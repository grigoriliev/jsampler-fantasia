 ...
 * @author Grigor Iliev
 */
public class AddOrchestraDlg extends OkCancelDialog {
	private final JLabel lName = new JLabel(i18n.getLabel("AddOrchestraDlg.lName"));
	private final JLabel lDesc = new JLabel(i18n.getLabel("AddOrchestraDlg.lDesc"));
	...
	/** Creates a new instance of <code>AddOrchestraDlg</code>. */
	public AddOrchestraDlg() { this(new DefaultOrchestraModel()); }
	
	/**
	 * Creates a new instance of <code>AddOrchestraDlg</code>.
	 * @param orchestra The orchestra model to modify.
	 */
	public AddOrchestraDlg(OrchestraModel orchestra) {
		super(CC.getMainFrame(), i18n.getLabel("AddOrchestraDlg.title"));
