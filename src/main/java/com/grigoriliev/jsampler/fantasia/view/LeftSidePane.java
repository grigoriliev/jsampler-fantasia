...
public class LeftSidePane extends FantasiaPanel {
	...
	LeftSidePane() {
		...
		tp.addTab(FantasiaI18n.i18n.getLabel("LeftSidePane.tabOrchestras"), orchestraPane);
		tp.addTab(FantasiaI18n.i18n.getLabel("LeftSidePane.tabMidiInstruments"), midiInstrumentsPane);
