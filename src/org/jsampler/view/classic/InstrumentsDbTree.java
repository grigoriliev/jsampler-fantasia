 ...
 * @author Grigor Iliev
 */
public class InstrumentsDbTree extends org.jsampler.view.AbstractInstrumentsDbTree {
	
	/** Creates a new instance of <code>InstrumentsDbTree</code>. */
	public
	InstrumentsDbTree(InstrumentsDbTreeModel model) {
		super(model);
	...
	private class CellRenderer extends DefaultTreeCellRenderer {
		...
		getTreeCellRendererComponent (
			...
			if(node.getInfo().getName() == "/") setIcon(Res.iconDb16);
			else if(leaf) setIcon(Res.iconInstrument16);
			else if(expanded) setIcon(Res.iconFolderOpen16);
			else setIcon(Res.iconFolder16);
