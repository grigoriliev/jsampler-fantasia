 ...
 * @author Grigor Iliev
 */
public class DbInstrumentPropsPane extends JPanel {
	private final JLabel lName = new JLabel(i18n.getLabel("DbInstrumentPropsPane.lName"));
	private final JLabel lLocation =
		new JLabel(i18n.getLabel("DbInstrumentPropsPane.lLocation"));
	
	private final JLabel lSize = new JLabel(i18n.getLabel("DbInstrumentPropsPane.lSize"));
	
	private final JLabel lFormat = new JLabel(i18n.getLabel("DbInstrumentPropsPane.lFormat"));
	private final JLabel lType = new JLabel(i18n.getLabel("DbInstrumentPropsPane.lType"));
	private final JLabel lDesc = new JLabel(i18n.getLabel("DbInstrumentPropsPane.lDesc"));
	private final JLabel lCreated = new JLabel(i18n.getLabel("DbInstrumentPropsPane.lCreated"));
	private final JLabel lModified =
		new JLabel(i18n.getLabel("DbInstrumentPropsPane.lModified"));
	
	private final JLabel lFile = new JLabel(i18n.getLabel("DbInstrumentPropsPane.lFile"));
	private final JLabel lIndex = new JLabel(i18n.getLabel("DbInstrumentPropsPane.lIndex"));
	private final JLabel lProduct = new JLabel(i18n.getLabel("DbInstrumentPropsPane.lProduct"));
	private final JLabel lArtists = new JLabel(i18n.getLabel("DbInstrumentPropsPane.lArtists"));
	private final JLabel lKeywords =
		new JLabel(i18n.getLabel("DbInstrumentPropsPane.lKeywords"));
	...
	/** Creates a new instance of <code>DbInstrumentPropsPane</code> */
	public DbInstrumentPropsPane(DbInstrumentInfo instrInfo) {
	...
	setInstrumentInfo(DbInstrumentInfo instrInfo) {
		...
		if(instrInfo.isDrum()) taType.setText(i18n.getLabel("DbInstrumentPropsPane.drum"));
		else taType.setText(i18n.getLabel("DbInstrumentPropsPane.chromatic"));
