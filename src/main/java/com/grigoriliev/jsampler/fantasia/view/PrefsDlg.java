...
import com.grigoriliev.jsampler.swing.view.std.JSViewProps;
...
public class PrefsDlg extends EnhancedDialog {
	...
	PrefsDlg(Frame owner) { 
		super(owner, FantasiaI18n.i18n.getLabel("PrefsDlg.title"), true);
		...
		tp.addTab(FantasiaI18n.i18n.getLabel("PrefsDlg.tabGeneral"), genPane);
		tp.addTab(FantasiaI18n.i18n.getLabel("PrefsDlg.tabView"), viewPane);
		tp.addTab(FantasiaI18n.i18n.getLabel("PrefsDlg.tabChannels"), channelsPane);
		tp.addTab(FantasiaI18n.i18n.getLabel("PrefsDlg.tabConsole"), consolePane);
		
		JPanel p = new JPanel();
		p.setLayout(new BorderLayout());
		p.setBorder(BorderFactory.createEmptyBorder(6, 6, 6, 6));
		p.add(connectionPane);
		tp.addTab(FantasiaI18n.i18n.getLabel("PrefsDlg.tabBackend"), p);
		tp.addTab(FantasiaI18n.i18n.getLabel("PrefsDlg.tabDefaults"), defaultsPane);
...
class GeneralPane extends JPanel {
	private final JCheckBox checkShowLSConsoleWhenRunScript =
		new JCheckBox(FantasiaI18n.i18n.getLabel("GeneralPane.checkShowLSConsoleWhenRunScript"));
	
	private final JCheckBox checkShowVolumesInDecibels =
		new JCheckBox(FantasiaI18n.i18n.getLabel("GeneralPane.checkShowVolumesInDecibels"));
...
class ViewPane extends JPanel {
	private final JCheckBox checkTurnOffAnimationEffects =
		new JCheckBox(FantasiaI18n.i18n.getLabel("GeneralPane.checkTurnOffAnimationEffects"));
	
	private final JCheckBox checkTurnOffCustomWindowDecoration =
		new JCheckBox(FantasiaI18n.i18n.getLabel("ViewPane.checkTurnOffCustomWindowDecoration"));
	
	private final JCheckBox checkShowInstrumentsDb =
		new JCheckBox(FantasiaI18n.i18n.getLabel("ViewPane.checkShowInstrumentsDb"));
	
	private final JCheckBox checkUseNativeFileChoosers =
		new JCheckBox(FantasiaI18n.i18n.getLabel("ViewPane.checkUseNativeFileChoosers"));
...
class ChannelsPropsPane extends JPanel {
	private final JCheckBox checkShowChannelNumbering =
		new JCheckBox(FantasiaI18n.i18n.getLabel("ChannelsPropsPane.checkShowChannelNumbering"));
	
	private final JCheckBox checkShowMidiInfo =
		new JCheckBox(FantasiaI18n.i18n.getLabel("ChannelsPropsPane.checkShowMidiInfo"));
	
	private final JCheckBox checkShowStreamVoiceCount =
		new JCheckBox(FantasiaI18n.i18n.getLabel("ChannelsPropsPane.checkShowStreamVoiceCount"));

	private final JLabel lChannelLaneNumber =
		new JLabel(FantasiaI18n.i18n.getLabel("ChannelsPropsPane.lChannelLaneNumber"));
	...
	createSmallViewPane() {
		...
		String s = FantasiaI18n.i18n.getLabel("ChannelsPropsPane.smallView");
	...
	createChannelLanesPane() {
		...
		String s = FantasiaI18n.i18n.getLabel("ChannelsPropsPane.channelLanes");
