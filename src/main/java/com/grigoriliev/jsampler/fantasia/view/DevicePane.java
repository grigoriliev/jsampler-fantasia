...
import com.grigoriliev.jsampler.fantasia.view.basic.FantasiaLabel;
...
public class DevicePane extends JPanel {
	...
	private class OptionsButton extends PixmapToggleButton implements ActionListener {
		...
		showOptionsPane(boolean show) {
			...
			String s;
			if(isSelected()) s = FantasiaI18n.i18n.getButtonLabel("DevicePane.ttHideOptions");
			else s = FantasiaI18n.i18n.getButtonLabel("DevicePane.ttShowOptions");
	...
	private class ConfirmRemovalPane extends PixmapPane implements ActionListener {
		private final JButton btnRemove = new JButton(FantasiaI18n.i18n.getButtonLabel("DevicePane.btnRemove"));
		private final JButton btnCancel = new JButton(FantasiaI18n.i18n.getButtonLabel("cancel"));
