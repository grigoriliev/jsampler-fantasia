...
public class InstrumentChooser extends OkCancelDialog {
	private final JRadioButton rbSelectFromOrchestra =
		new JRadioButton(i18n.getLabel("InstrumentChooser.rbSelectFromOrchestra"));
	private final JRadioButton rbSelectFromDb =
		new JRadioButton(i18n.getLabel("InstrumentChooser.rbSelectFromDb"));
	private final JRadioButton rbSelectFromFile =
		new JRadioButton(i18n.getLabel("InstrumentChooser.rbSelectFromFile"));
	
	
	private final JLabel lOrchestra = new JLabel(i18n.getLabel("InstrumentChooser.lOrchestra"));
	
	private final JLabel lInstrument =
		new JLabel(i18n.getLabel("InstrumentChooser.lInstrument"));
	...
	createDbPane() {
		...
		btnBrowseDb.addActionListener(new ActionListener() {
			...
			actionPerformed(ActionEvent e) {
				...
				DbInstrumentChooser dlg;
				dlg = new DbInstrumentChooser(InstrumentChooser.this);
